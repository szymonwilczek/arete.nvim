...
and imported Ef, Modus, Standard, and Tempus theme tables.

Ef data is generated from the local `ef-themes.nvim` output, with newer missing
themes filled from the Emacs `ef-themes` package. Modus and Standard data are
generated from their Emacs packages. Tempus data is generated from the official
